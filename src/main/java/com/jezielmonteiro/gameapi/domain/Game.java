...
public class Game {
    ...
    public Game(String title, String developer, Integer releaseYear) {
        validate(title, developer, releaseYear);
        this.id = new GameId();
        this.title = title;
    ...
    public Game(GameId id, String title, String developer,
                Integer releaseYear) {
        Assert.notNull(id,
    ...
    public void update(String title, String developer,
                       Integer releaseYear) {
        validate(title, developer, releaseYear);
        this.title = title;
        this.developer = developer;
    ...
    private static void validate(String title, String developer,
                                 Integer releaseYear) {
